...
from course_discovery.apps.api.v1.views.courses import CourseViewSet, CourseRecommendationViewSet
...
router.register(r'course_recommendations', CourseRecommendationViewSet, basename='course')
